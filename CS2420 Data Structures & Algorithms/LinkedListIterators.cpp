...
#include <vector>
#include <sstream>
#include <iterator> // Required for iterator traits
...
public:
    Iterator& operator++() {
        if (ptr != nullptr && !offTheRightCliff) {
...
int main() {
    ...
    cout << "List contents: " << list.getStringFromList() << endl;
    ...
    cout << "List after reverse: " << list.getStringFromList() << endl;
